...
class About extends Component {
  render() {
    return (
      ...
      <p id="me"> Hello, my name is<span class="highlight"> Sarah Lund</span> and <br/>I am a NYC-based web developer!<br/>
       I am a <span class="highlight">visual</span> and <span class="highlight">analytical</span> thinker who enjoys <br/>bringing <span class="highlight">creative</span> solutions
      to modern web applications.<br/>
      Please explore my projects and get in touch if <br/> you are interested in working <span class="highlight">together!</span></p>
