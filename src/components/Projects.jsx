...
class Projects extends Component {
 ...
 <p class="tech">  HTML, Javascript, Shopify SDK, CSS3 </p>
  ...
  <a target="_blank" href="http://art-aficionado.surge.sh"><img class="big" src="https://i.imgur.com/tVEikzq.png"/></a>
   ...
   <p class="projectlink"> <a target="_blank" href="http://pick-your-own.surge.sh/">React Giphy</a></p>
   <p class="tech"> React.js, Giphy API, CSS3 </p>
   <a target="_blank" href="http://pick-your-own.surge.sh/"><img class="big" src="https://i.imgur.com/glJ728e.png" alt="giphypic"/></a>
